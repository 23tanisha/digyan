...
const players = [
    ...
    { id: 'player2', videoId: 'WLEruSGsGxQ', player: null },
    ...
    const getEvent = function () {
        ...
        swipeStart = function () {
            ...
            if (allowSwipe) {
                ...
                document.addEventListener('touchmove', swipeAction , { passive: true });
                document.addEventListener('mousemove', swipeAction , { passive: true });
                document.addEventListener('touchend', swipeEnd , { passive: true });
                document.addEventListener('mouseup', swipeEnd , { passive: true });
